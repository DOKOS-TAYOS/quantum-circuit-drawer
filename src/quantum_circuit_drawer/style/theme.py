...
THEMES: dict[str, DrawTheme] = {
    ...
    "accessible": DrawTheme(
        name="accessible",
        figure_facecolor="#ffffff",
        axes_facecolor="#ffffff",
        wire_color="#000000",
        classical_wire_color="#4d4d4d",
        gate_facecolor="#ffffff",
        gate_edgecolor="#000000",
        measurement_facecolor="#f0f0f0",
        text_color="#000000",
        barrier_color="#666666",
        measurement_color="#000000",
        accent_color="#0072B2",
        control_color="#000000",
        control_connection_color="#D55E00",
        topology_edge_color="#000000",
        topology_plane_color="#009E73",
        hover_text_color="#ffffff",
        hover_facecolor="#000000",
        hover_edgecolor="#ffffff",
        ui_surface_facecolor="#ffffff",
        ui_surface_hover_facecolor="#f0f0f0",
        ui_surface_facecolor_disabled="#ffffff",
        ui_surface_edgecolor="#000000",
        ui_surface_edgecolor_active="#0072B2",
        ui_surface_edgecolor_disabled="#666666",
        ui_text_color="#000000",
        ui_secondary_text_color="#4d4d4d",
        ui_disabled_text_color="#666666",
        ui_accent_color="#0072B2",
        ui_accent_edgecolor="#000000",
        ui_slider_track_color="#4d4d4d",
        ui_slider_fill_color="#0072B2",
    ),
    "dark": DrawTheme(
        name="dark",
