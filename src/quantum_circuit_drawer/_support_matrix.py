...
CAPABILITY_SUPPORT_ROWS: tuple[CapabilitySupportRow, ...] = (
    ...
    CapabilitySupportRow(
        ...
        classical_control_flow="`if`/`for`/`while` bodies framed; `switch` shows cases",
    ...
    CapabilitySupportRow(
        ...
        classical_control_flow="Structured flow compact with visible summaries; low-level CFG outside subset",
