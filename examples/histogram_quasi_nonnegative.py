...
def build_quasi_distribution() -> dict[str, float]:
    """Return a quasi-probability distribution with only non-negative values."""
...
def main() -> None:
    """Render a quasi-probability histogram that stays above zero."""
...
def _parse_args() -> tuple[Path | None, bool]:
    parser = ArgumentParser(
        description="Render a quasi-probability histogram without negative bars."
    )
