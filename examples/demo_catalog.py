...
def get_demo_catalog() -> tuple[DemoSpec, ...]:
    ...
    return (
        ...
        DemoSpec(
            ...
            description="Qiskit showcase for expanded control-flow frames, switch summaries, and open controls",
            module_name="examples.qiskit_control_flow_showcase",
            builder_name="build_circuit",
            framework="qiskit",
            default_qubits=5,
            default_columns=4,
            columns_help="Loop span to show in the Qiskit for-loop frame label",
            dependency_module="qiskit",
        ),
        DemoSpec(
            demo_id="qiskit-composite-modes-showcase",
            description="Qiskit showcase for composites, StatePreparation, and dagger labels",
        ...
        DemoSpec(
            ...
            description="CUDA-Q showcase for the supported subset with reset, basis measurements, and static control summaries",
