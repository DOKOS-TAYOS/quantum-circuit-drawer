...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Identity", "I", CanonicalGateFamily.CUSTOM),
        ("id", "I", CanonicalGateFamily.CUSTOM),
        ("ResetChannel", "RESET", CanonicalGateFamily.CUSTOM),
        ("delay", "DELAY", CanonicalGateFamily.CUSTOM),
        ("Adjoint(S)", "Sdg", CanonicalGateFamily.SDG),
        ("Adjoint(T)", "Tdg", CanonicalGateFamily.TDG),
        ("Adjoint(SX)", "SXdg", CanonicalGateFamily.SXDG),
        ("RXXGate", "RXX", CanonicalGateFamily.CUSTOM),
        ("RYYGate", "RYY", CanonicalGateFamily.CUSTOM),
        ("RZZGate", "RZZ", CanonicalGateFamily.CUSTOM),
        ("RZXGate", "RZX", CanonicalGateFamily.CUSTOM),
        ("FSimGate", "FSIM", CanonicalGateFamily.CUSTOM),
        ("ECRGate", "ECR", CanonicalGateFamily.CUSTOM),
